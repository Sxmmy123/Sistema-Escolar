...
export function AdminDashboard() {
  return appShell("admin", "/admin", `
    <section class="rounded-2xl bg-white p-4 shadow-soft sm:p-5">
      ...
      <p class="mt-1 max-w-3xl text-sm font-semibold leading-6 text-slate-500 sm:text-base">Gestiona alumnos, docentes, director, horarios y auditoria.</p>
    </section>
    ...
    <section class="mt-3 grid grid-cols-1 gap-3 sm:mt-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
